...
The child theme ships sixteen toggleable SEO modules under
...
| `reading-time-badge` | Frontend "⏱ N دقيقة قراءة" badge near the post title, reusing the cached value from `serp-ctr`                       |
